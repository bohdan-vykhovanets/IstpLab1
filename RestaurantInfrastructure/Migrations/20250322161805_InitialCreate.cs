        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationDateStart = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ReservationDateEnd = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "CousineMenuItem",
                columns: table => new
                {
                    CousinesId = table.Column<int>(type: "integer", nullable: false),
                    MenuItemsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CousineMenuItem", x => new { x.CousinesId, x.MenuItemsId });
                    table.ForeignKey(
                        name: "FK_CousineMenuItem_Cousines_CousinesId",
                        column: x => x.CousinesId,
                        principalTable: "Cousines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CousineMenuItem_MenuItems_MenuItemsId",
                        column: x => x.MenuItemsId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PreOrders_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CousineMenuItem_MenuItemsId",
                table: "CousineMenuItem",
                column: "MenuItemsId");

            migrationBuilder.CreateIndex(
                name: "IX_PreOrders_MenuItemId",
                table: "PreOrders",
                column: "MenuItemId");
